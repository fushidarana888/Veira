...
set solo_only=false,
    ...
    party_attack_per_extra=0.08,
    party_defense_per_extra=0.05,
    repeat_reward_gold=0,
    repeat_reward_experience=0,
    updated_at=now()
...
begin
  ...
  if event_row.solo_only and p_mode='party' and event_row.boss_kind<>'world_enemy' then
