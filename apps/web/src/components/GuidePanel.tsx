            ...
            <>
              ...
              <div className="guide-rule-grid">
                ...
                <GuideRule title="Инициатива и частота ходов">
                  ...
                  Если она выше инициативы противника, персонаж постепенно накапливает <b>темп действия</b>.
                  При <b>100 темпа</b> он получает ещё одно полноценное действие до ответа противника.
                  Система сглажена: за одно действие можно получить не больше <b>25 темпа</b>, поэтому даже очень
                  быстрый персонаж в долгом бою действует максимум примерно на четверть чаще, а не в два раза чаще.
