      ...
      <article className="panel">
        <div className="section-heading">
          <div>
            ...
            <h2>Редактор рас</h2>
            <p className="muted">
              Раса влияет на характеристики, ОЗ, ману, восстановление, сопротивления, стихию и боевые особенности. Все игровые расы доступны всем игрокам.
            </p>
          </div>
