          ...
          <article className="panel gm-content-form">
            ...
            {itemDraft.category === 'weapon' && (
              <>
                ...
                <div className="gm-form-grid two">
                  <label>
                    ...
                    >
                      ...
                      <option value="blade">Клинок</option>
                      ...
                      <option value="club">Дубина</option>
                ...
                <p className="muted">
                  Базовый урон добавляется к урону от характеристик и уровня. Семейства: кинжал ×0,80 после защиты; рапира игнорирует 10% физической защиты; клинок всегда получает максимальный разброс урона +4; катана получает «Нарастающий ритм» (+8% за последовательную физическую атаку по той же цели, максимум +40%, любое своё другое действие сбрасывает); копьё учитывает 120% физической защиты и компенсирует это повышенным базовым уроном; топор/секира получают до +20% урона от макс. ОЗ цели; булава/молот имеют 8% шанс оглушения в соло/дуэли и 5% в пати; дубина усиливает уязвимость к дробящему ×1,5 и учитывает только 50% сопротивления дробящему; двуручный меч получает +5 п.п. шанса крита после каждого успешного некритического физического попадания, до общего капа 60%, а крит двуручником сбрасывает накопление. Уникальные пассивки предмета считаются отдельно.
                </p>
          ...
          <article className="panel gm-content-form">
            ...
            {spellDraft.spell_kind === 'sacrifice' && (
              <div className="gm-editor-box">
                ...
                <p className="muted">
                  Условие применения — больше 200 текущего ОЗ. Использующий становится Потерянным до конца всего похода. Эффект можно активировать только один раз за бой-поход.
                </p>
              </div>
            )}
