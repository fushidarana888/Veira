          ...
          <article className="panel gm-content-form">
            ...
            {itemDraft.category === 'weapon' && (
              <>
                ...
                <p className="muted">
                  Базовый урон добавляется к урону от характеристик и уровня. Семейства: кинжал ×0.80 после защиты; рапира игнорирует 10% Physical Defense; клинок всегда получает максимальный разброс урона +4; катана получает «Нарастающий ритм» (+8% за последовательную физическую атаку по той же цели, максимум +40%, любое своё другое действие сбрасывает); копьё учитывает 120% Physical Defense и компенсирует это повышенным base damage; топор/секира получают до +20% урона от Max HP цели; булава/молот имеют 8% шанс оглушения в соло/PvP и 5% в пати; дубина усиливает уязвимость к дробящему ×1.5 и учитывает только 50% сопротивления дробящему; двуручный меч получает +5 п.п. Crit Chance после каждого успешного некритического физического попадания, до общего капа 60%, а крит двуручником сбрасывает накопление. Уникальные пассивки предмета считаются отдельно.
                </p>
